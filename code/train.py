...
if __name__ == "__main__":
	...
	( inputs, pipeline ) = get_base_pipeline( image_shape, batch_size, regularization, modality+'_')
	outputs = tf.keras.layers.Dense(num_classes, activation='softmax')(pipeline)
